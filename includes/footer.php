     ...
     <div class="cuntainer">
        <div class="wolf">
            ...
            <div class="footer-ol">
                <h4>online shop</h4>
                <ul>
                    <li><a href="trimer.php?cat_id=7">Handicrafts</a></li><br><br>
                    <li><a href="trimer.php?cat_id=8">Arts</a></li><br><br>
                    <li><a href="trimer.php?cat_id=9">Textiles</a></li><br><br>
                    <li><a href="trimer.php?cat_id=10">Jerellery</a></li><br><br>
            ...
            <p class="credit">Copyright &copy; <span>2015-2021</span> | all rights reserved. | <span>Designed With By Your RSP</span></p>
        </div>
     </div>
  </footer>
